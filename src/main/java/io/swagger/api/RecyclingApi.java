...
public interface RecyclingApi {
    ...
    @Operation(summary = "Get recycling information", description = "", tags={ "recycling" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(schema = @Schema(implementation = Recycling.class))) })
    @RequestMapping(value = "/recycling",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Recycling> getRecycling();


    @Operation(summary = "Update about page", description = "", security = {
        @SecurityRequirement(name = "recstore_auth", scopes = {
            "write:content"        })    }, tags={ "recycling" })
    @ApiResponses(value = { 
